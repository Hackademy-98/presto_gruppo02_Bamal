        ...
        <div class="row">
            <div class="col-12 p-4 bg-transparent pb-5 shadow-lg form rounded-5 mt-4 col-md-7 mt-3">                    
                ...
                <form wire:submit.prevent='store'>
                    ...
                    <div class="mb-3">
                        <input wire:model="temporary_images" type="file" class="form-control shadow" name="images" multiple class="form-controll shadow @erorr("temporany_images.*") is-invalid @enderorr" placeholder="Img"/>
